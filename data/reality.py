...
accounts = [
    ...
    Account(name="Checking", balance=149),
...
txs = [
    ...
    Transaction(name="Fair",            category="once",    schedule=Once(2019,2,10),   value=-545),                         ### WINDFALLS
    Transaction(name="HalfFair",        category="once",    schedule=Once(2019,2,10),   value=-280),
    Transaction(name="TowCar",          category="once",    schedule=Once(2019,2,10),   value=-200),
