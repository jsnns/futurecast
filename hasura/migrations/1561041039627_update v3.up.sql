...
CREATE TABLE public.subscriptions (
    ...
    name text,
    usefulness numeric DEFAULT 0.0
);
...
ALTER TABLE ONLY public.subscriptions
    ADD CONSTRAINT subscriptions_owner_fkey FOREIGN KEY (owner) REFERENCES public.users(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE ONLY public.transactions
...
ALTER TABLE ONLY public.wishes
    ADD CONSTRAINT wish_owner_fkey FOREIGN KEY (owner) REFERENCES public.users(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
